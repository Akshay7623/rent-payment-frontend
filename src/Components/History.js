  ...
  return (
    <>
      <div className="container">
        <Header ShowImg={true} title={"History"}></Header>
        ...
        <div className="pb-2">
          <div className="appContent1 pb-5">
            <ul className="nav nav-tabs size2"
              style={{ backgroundColor: "#e0e3e8" }} >
            ...
            {HistoryData[0] ? (
              Object.values(HistoryData).map((values, index) => {
                return (
                        ...
                        <div style={{
                          ...
                          <div className="card-body">
                            <h5 className="card-title">
                              <span>Date :</span>{" "}
                              {new Date(values.paymentCreatedAt).toLocaleDateString().split("/").join("-") +
                                ` ` +
                                new Date(values.paymentCreatedAt).toTimeString().substring(0, 8)}
                            </h5>
                            ...
                            <p>
                              <span>Mobile : </span> {values.mobile}
                            </p>
                            <p>
                              <span>Amount : ₹</span> {values.amount}
                            </p>
                            <p>
                              <span>Order ID : </span> {values.orderId}
                            </p>
                            <p>
                              <span>Txn ID : </span> {values._id}
                            </p>
                          </div>
                        </div>
                      </div>
